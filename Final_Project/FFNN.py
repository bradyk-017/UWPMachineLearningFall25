...
def peak_learn_rate(x, y, learn: list[float], hidden: int):
    ...
    for i in np.arange(learn[0], learn[1], learn[2]):
        ...
        # Runs the training of the network and plots the MSE Loss and confusion matrix for the instance
        balanced_accuracy = train_and_plot_network(one_layer_network, x_train, y_train, x_test, y_test)
        #balanced_accuracy = train_and_plot_network(two_layer_network, x_train, y_train, x_test, y_test)
...
def main():
    ...
    # Lists for running through checks
    ...
    # Create Two Layer Neural Network and and trains and plots it
