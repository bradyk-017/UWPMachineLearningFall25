...
def main():
    ...
    all_y_predicted_hard = np.where(all_y_predicted_soft >= 0.5, 1, 0)

    print("Test balanced accuracy: ", balanced_accuracy_score(y_test, all_y_predicted_hard))

    cm = confusion_matrix(y_test, all_y_predicted_hard)
