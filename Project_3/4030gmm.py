...
def EM_uwplatt_maximization(ext_matrix, mean_matrix, cov_matrix, component_weights_matrix):
    ...
    @@ -278,61 +280,70 @@ def EM_uwplatt_maximization(ext_matrix, mean_matrix, cov_matrix, component_weigh
...
def sample_log_likelihood(x, mean_matrix, cov_matrix, cw_matrix):
    ...
    @@ -362,16 +373,8 @@ def classify_with_likelihood_ratio(test_set, gmm0, gmm1):
...
def EM_uwplatt_test_convergence(log_likelihoods, iteration):
    ...
    @@ -399,8 +402,10 @@ def EM_uwplatt_contour_plot(mean_matrix, cov_matrix, cw_matrix, label):
...
def EM_uwplatt_contour_plot(mean_matrix, cov_matrix, cw_matrix, label):
    ...
    @@ -462,7 +467,13 @@ def EM_uwplatt_3D_plot(mean_matrix, cov_matrix, cw_matrix, label):
...
def det_curve(confusion_matrix):
    ...
    @@ -487,50 +498,48 @@ def det_curve(confusion_matrix):
...
def main():
    ...
    confusion_matrix, accuracy = classify_with_likelihood_ratio(test_set, gmm0, gmm1)
